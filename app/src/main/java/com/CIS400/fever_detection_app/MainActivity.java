                                ...
                                if(!user.getEmailVerified()) {
                                    MyUser.requestEmailVerify(emailText.getText().toString().trim(), new UpdateListener() {
                                        ...
                                        public void done(BmobException e) {
                                            if (e == null) {
                                                Toast.makeText(MainActivity.this, "Your email has not verified yet, We just sent you a verification in your Email.", Toast.LENGTH_LONG).show();
                                            } else {
                                                Toast.makeText(MainActivity.this, "Your email has not verified yet, and verification failed: " + e.getMessage(), Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    });
                                }else {
